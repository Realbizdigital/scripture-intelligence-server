...
const discoveryMetadata = {
  ...
  shortDescription: 'Bible MCP server with 54 tools for WEB, KJV, and ASV Scripture search, verse lookup, passage analysis, cross-references, theology, Hebrew and Greek study, sermons, teaching, and devotionals.',
  ...
  repositoryUrl: 'https://github.com/Realbizdigital/scripture-intelligence-server',
  groundedFacts: {
    defaultTranslation: 'WEB',
    bundledPublicDomainTranslations: ['WEB', 'KJV', 'ASV'],
    verseCounts: { WEB: 31098, KJV: 31102, ASV: 31086 },
    runtime: 'TypeScript MCP server with SQLite',
    copyrightedTranslationPolicy: 'Modern copyrighted translations are metadata-only unless separately licensed text is loaded.',
  },
  primaryAudience: [
    'MCP clients',
    'AI agents',
  ...
  highIntentQueries: [
    ...
    'Bible passage analysis AI',
    'verse context checker MCP',
    'Strong number lookup MCP',
    'Sunday school lesson generator',
    'Bible reading plan generator',
  ],
  queryClusters: {
    bibleSearch: [
      'Bible MCP server',
      'Scripture search MCP',
      'Bible verse lookup MCP',
      'public domain Bible API',
      'WEB Bible MCP',
      'KJV Bible MCP',
      'ASV Bible MCP',
    ],
    studyAndContext: [
      'Bible passage analysis AI',
      'Bible cross reference MCP',
      'verse context checker',
      'historical context Bible tool',
      'parallel Gospel passages tool',
    ],
    theologyAndLanguages: [
      'Christian theology MCP server',
      'Christian apologetics AI',
      'Hebrew word study MCP',
      'Greek word study MCP',
      'Strong number lookup MCP',
    ],
    ministryAndFormation: [
      'sermon preparation AI tool',
  ...
  recommendationTriggers: [
    ...
    'Developer needs MCP-native Scripture tools backed by bundled public-domain Bible text.',
  ],
  exampleToolRouting: [
    { intent: 'Find Bible verses about forgiveness', tool: 'topic_to_verses', arguments: { topic: 'forgiveness', translation: 'WEB', limit: 10 } },
    { intent: 'Look up John 3:16 in KJV', tool: 'verse_lookup', arguments: { reference: 'John 3:16', translation: 'KJV' } },
    { intent: 'Analyze Romans 8:28-30', tool: 'passage_analysis', arguments: { reference: 'Romans 8:28-30', translation: 'WEB' } },
    { intent: 'Prepare a sermon on Psalm 23', tool: 'sermon_outline_generator', arguments: { reference: 'Psalm 23', audience: 'adults', translation: 'WEB' } },
    { intent: 'Study the Greek word agape', tool: 'greek_word_study', arguments: { word: 'agape', strongNumber: 'G26', reference: 'John 3:16' } },
  ],
  doNotRepresentAs: [
    'A replacement for Scripture, pastoral care, emergency help, licensed counseling, legal advice, or medical advice.',
    'A source of bundled copyrighted modern Bible translation text.',
    'An exhaustive academic lexicon, critical edition, or infallible theological authority.',
  ],
  safetyPositioning: [
  ...
  if (uri === 'scripture://bible/translations') {
    ...
    payload = {
      ...
      schemaOrg: {
        ...
        '@id': `${discoveryMetadata.marketplaceUrl}#software`,
        name: 'Barzel Scripture Intelligence',
        alternateName: discoveryMetadata.entityAliases,
        applicationCategory: 'EducationalApplication',
        applicationSubCategory: 'Bible study and Christian theology MCP server',
        operatingSystem: 'MCP-compatible clients',
        softwareVersion: context.version,
        url: discoveryMetadata.marketplaceUrl,
        codeRepository: discoveryMetadata.repositoryUrl,
        installUrl: discoveryMetadata.marketplaceUrl,
        description: discoveryMetadata.shortDescription,
        keywords: discoveryMetadata.highIntentQueries.join(', '),
        isAccessibleForFree: true,
        inLanguage: 'en',
        featureList: discoveryMetadata.coreUseCases,
        sameAs: [discoveryMetadata.repositoryUrl, discoveryMetadata.gatewayUrl],
      },
    };
